...
class Config(object):
  ...
  AWS_S3_KEY_PREFIX = "qixshawnchen/"
  AWS_S3_ACL = "private"
  ...
  AWS_SNS_JOB_COMPLETE_TOPIC = \
    "arn:aws:sns:us-east-1:659248683008:qixshawnchen_job_results"
  AWS_SNS_JOB_ARCHIVE_TOPIC = \
    "arn:aws:sns:us-east-1:659248683008:qixshawnchen_archive"
  AWS_SNS_JOB_THAW_TOPIC = \
    "arn:aws:sns:us-east-1:659248683008:qixshawnchen_thaw"
  AWS_SNS_JOB_RESTORE_TOPIC = \
    "arn:aws:sns:us-east-1:659248683008:qixshawnchen_restore"
  
  TOPIC_ARN_REQUESTS = "arn:aws:sns:us-east-1:659248683008:qixshawnchen_job_requests"
  TOPIC_ARN_RESULTS = "arn:aws:sqs:us-east-1:659248683008:qixshawnchen_job_results"
  TOPIC_ARN_ARCHIVE = "arn:aws:sns:us-east-1:659248683008:qixshawnchen_archive"
  TOPIC_ARN_THAW = "arn:aws:sns:us-east-1:659248683008:qixshawnchen_thaw"
  TOPIC_ARN_RESTORE = "arn:aws:sns:us-east-1:659248683008:qixshawnchen_restore"

  # Change the table name to your own
  AWS_DYNAMODB_ANNOTATIONS_TABLE = "qixshawnchen_annotations"

  # Change the email address to your username
  MAIL_DEFAULT_SENDER = "qixshawnchen@mpcs-cc.com"
